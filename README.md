...
The platform is built on a modern, decoupled architecture designed for high availability and rapid scaling. It features a modern HTML5/JS frontend communicating with a high-concurrency Flask backend, orchestrated by a 4-tier Gemini AI fallback cluster.
...
| :--- | :--- | :--- |
| **Frontend** | Tailwind CSS + Vanilla JS | Responsive UI with Chart.js visualization. |
